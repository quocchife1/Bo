...
namespace SkyWarriorsClashofTitans
{
    public partial class Form1 : Form
    {
        ...
        private void gameOver()
        {
            ...
            bulletF9.BackColor = Color.FromArgb(100,0,0,0);
            enemyOne.BackColor = Color.FromArgb(100,0,0,0);
            enemyTwo.BackColor = Color.FromArgb(100,0,0,0);
            enemyThree.BackColor = Color.FromArgb(100,0,0,0);
            enemyFour.BackColor = Color.FromArgb(100,0,0,0);
            pNoti.BackColor = Color.FromArgb(100,0,0,0);
            txtScore.BackColor = Color.FromArgb (100,0,0,0);


            noti.Text = txtScore.Text + Environment.NewLine + "Game Over !!!" + Environment.NewLine + "Press ENTER to try again";
            gameTimer.Stop();
        }
        #endregion
    }
